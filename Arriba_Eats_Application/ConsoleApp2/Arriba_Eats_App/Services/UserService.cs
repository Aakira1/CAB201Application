...
namespace Arriba_Eats_App.Services
{
	...
	public class UserService
	{
		...
		public void DisplayAllUsers()
		{
			...
			Console.WriteLine($"{"ID".PadRight(idWidth)} | {"Name".PadRight(nameWidth)} | {"Username".PadRight(usernameWidth)} | {"Email".PadRight(emailWidth)} | {"Phone".PadRight(phoneWidth)} | {"Balance".PadRight(balanceWidth)}");
			Console.WriteLine(new string('-', idWidth + nameWidth + usernameWidth + emailWidth + phoneWidth + balanceWidth + 10));
